    ...
    public class WindowMainViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public WindowMainViewModel(Canvas drawContext, Image image)
        {
            ...
            _selectedModeList = new List<SelectedMode>() {
                ...
                { new SelectedMode(43, "Узл-2", "480", "Цифровой 48", "ЦТРС 1") },
                { new SelectedMode(44, "Узл-2", "480", "Цифровой 48", "ЦТРС 2") },
                { new SelectedMode(45, "Узл-2", "480", "Аналоговый 48", "ЦТРС 1") },
                { new SelectedMode(46, "Узл-2", "480", "Аналоговый 48", "ЦТРС 2") },
                { new SelectedMode(47, "Узл-2", "2x480", "Цифровой 48", "ЦТРС 1") },
                { new SelectedMode(48, "Узл-2", "2x480", "Цифровой 48", "ЦТРС 2") },
                { new SelectedMode(49, "Узл-2", "2x480", "Аналоговый 48", "ЦТРС 1") },
                { new SelectedMode(50, "Узл-2", "2x480", "Аналоговый 48", "ЦТРС 2") },
                { new SelectedMode(51, "Узл-2", "2048", "Цифровой 48", "ЦТРС 1") },
                { new SelectedMode(52, "Узл-2", "2048", "Цифровой 48", "ЦТРС 2") },
                { new SelectedMode(53, "Узл-2", "2048", "Аналоговый 48", "ЦТРС 1") },
                { new SelectedMode(54, "Узл-2", "2048", "Аналоговый 48", "ЦТРС 2") },
                { new SelectedMode(55, "Узл-1", "480", "Цифровой 48", "ЦТРС 1") },
                { new SelectedMode(55, "Узл-1", "480", "Цифровой 48", "ЦТРС 2") },
                { new SelectedMode(56, "Узл-1", "480", "Аналоговый 48", "ЦТРС 1") },
                { new SelectedMode(56, "Узл-1", "480", "Аналоговый 48", "ЦТРС 2") },
                { new SelectedMode(57, "Узл-1", "2x480", "Цифровой 48", "ЦТРС 1") },
                { new SelectedMode(57, "Узл-1", "2x480", "Цифровой 48", "ЦТРС 2") },
                { new SelectedMode(58, "Узл-1", "2x480", "Аналоговый 48", "ЦТРС 1") },
                { new SelectedMode(58, "Узл-1", "2x480", "Аналоговый 48", "ЦТРС 2") },
                { new SelectedMode(39, "Ретр-2", "48", "Цифровой 48", "ЦТРС 1") },
                { new SelectedMode(40, "Ретр-2", "48", "Цифровой 48", "ЦТРС 2") },
                { new SelectedMode(59, "Ретр-2", "480", "Цифровой 480", "ЦТРС 1") },
                { new SelectedMode(60, "Ретр-2", "480", "Цифровой 480", "ЦТРС 2") },
                { new SelectedMode(61, "Ретр-2", "2x480", "Цифровой 480x2", "ЦТРС 1") },
                { new SelectedMode(62, "Ретр-2", "2x480", "Цифровой 480x2", "ЦТРС 2") },
                { new SelectedMode(59, "Ретр-2", "2048", "2048 внешний", "ЦТРС 1") },
                { new SelectedMode(60, "Ретр-2", "2048", "2048 внешний", "ЦТРС 2") },
                { new SelectedMode(38, "Ретр-1", "48", "Цифровой 48", "ЦТРС А->Б") },
                { new SelectedMode(37, "Ретр-1", "48", "Цифровой 48", "ЦТРС Б->А") },
                { new SelectedMode(63, "Ретр-1", "480", "Цифровой 480", "ЦТРС А->Б") },
                { new SelectedMode(64, "Ретр-1", "480", "Цифровой 480", "ЦТРС Б->А") },
                { new SelectedMode(65, "Ретр-1", "2x480", "Цифровой 480x2", "ЦТРС А->Б") },
                { new SelectedMode(66, "Ретр-1", "2x480", "Цифровой 480x2", "ЦТРС Б->А") },
                { new SelectedMode(63, "Ретр-1", "2048", "2048 внешний", "ЦТРС А->Б") },
                { new SelectedMode(64, "Ретр-1", "2048", "2048 внешний", "ЦТРС Б->А") }
            };
        }
