    ...
    public class WindowMainViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public WindowMainViewModel(Canvas drawContext, Image image)
        {
            ...
            _selectedModeList = new List<SelectedMode>() {
                ...
                { new SelectedMode(0, "Ретр-1", "480", "Цифровой 480", "ЦТРС А->Б") },
                { new SelectedMode(0, "Ретр-1", "480", "Цифровой 480", "ЦТРС Б->А") },
                { new SelectedMode(0, "Ретр-1", "2x480", "Цифровой 480x2", "ЦТРС А->Б") },
                { new SelectedMode(0, "Ретр-1", "2x480", "Цифровой 480x2", "ЦТРС Б->А") },
                { new SelectedMode(0, "Ретр-1", "2048", "2048 внешний", "ЦТРС А->Б") },
                { new SelectedMode(0, "Ретр-1", "2048", "2048 внешний", "ЦТРС Б->А") }
            };
        }
